...
var Module = function Module(_ref) {
  ...
  return function decorator(Class) {
    var ModuleClass = /*#__PURE__*/function (_Class) {
      _inherits(ModuleClass, _Class);
      var _super = _createSuper(ModuleClass);
      function ModuleClass() {
        var _this;
        _classCallCheck(this, ModuleClass);
        _this = _super.call(this);
        _defineProperty(_assertThisInitialized(_this), "injectables", {});
        _defineProperty(_assertThisInitialized(_this), "providers", {});
        _defineProperty(_assertThisInitialized(_this), "controllers", {});
        var _ref2 = arguments.length <= 0 ? undefined : arguments[0],
          injectables = _ref2.injectables;
        if (injectables !== undefined) {
          injectables.forEach(function (injectable) {
            return _this.injectables[injectable.provide.name] = injectable.useValue;
          });
        }
        providers.forEach(function (Provider) {
          var provider = new Provider(_this.injectables);
          _this.providers[provider.constructor.name] = provider;
        });
        controllers.map(function (Controller) {
          var controller = new Controller(_objectSpread(_objectSpread({}, _this.injectables), _this.providers));
          _this.controllers[controller.constructor.name] = controller;
        });
        return _this;
      }
    ...
    return function () {
      ...
      return _construct(ModuleClass, args);
    };
  };
};
